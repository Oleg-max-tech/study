        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="lg:w-4/6 text-lg">
            <p>
              ...
              підприємства або організації з метою представлення їх діяльності
              та послуг в Інтернеті. Такий веб-сайт містить інформацію про
              компанію, її історію, продукти та послуги, контактні дані, новини,
              інформацію про вакансії та іншу важливу інформацію про
              організацію.
            </p>
            <p className="mt-4">
              ...
              дуже простим або дуже складним, в залежності від розміру компанії
              та мети створення сайту.
            </p>
            <p className="mt-4">
              Корпоративний веб-сайт є важливим елементом брендингу та
              маркетингу, оскільки він дозволяє компанії встановити свій імідж,
              залучити нових клієнтів та зберегти старих. Крім того, він може
              бути використаний для забезпечення зв'язку зі співробітниками та
              партнерами компанії, а також для розміщення важливої інформації,
              такої як звіти про фінансову діяльність, прес-релізи та інше.
            </p>
          </div>
